...
class TagField(wtforms.StringField):
    def _value(self):
        if self.data:
            '''
            Display data as a comma-separated list.
            '''
    ...
    def get_tags_from_string(self, tag_string):
        ...
        '''
        Query the database and retrieve any tags we have already daved.
        '''
        existin_tags = Tag.query.filter(Tag.name.in_(tag_names))
        '''
        ...
        '''
        Return all the existing tags + all new tags.
        '''
